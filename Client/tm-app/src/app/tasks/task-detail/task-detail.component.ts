...
export class TaskDetailComponent implements OnInit, AfterViewInit{
  ...
  public constructor(
    ...
    this.taskDoneOptions = [
      { value: false, text: "в ожидании" },
      { value: true, text: "выполнена" }
    ];
  ...
  public ngOnInit(){
    ...
    .subscribe(
      ...
      error => alert("Произошла ошибка, повторите позже")
    )
  }
  ...
  public updateTask(){
    ...
    let isTrueSet = (this.form.get('done').value == 'true');
    this.task.done = isTrueSet;
